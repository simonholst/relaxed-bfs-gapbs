...
if [ $progress -eq 0 ]; then
    ...
    python3 bench.py -args "-g graphs/road_usa.mtx.sg -n 32"          -t 1 2 4 8 16 32 64 128 256 512 -d no -o athena/DO_TD/usa -a DO_TD -p athena_ht
...
if [ $progress -eq 1 ]; then
    ...
    python3 bench.py -args "-g graphs/europe_osm.mtx.sg -n 32"           -t 1 2 4 8 16 32 64 128 256 512 -d no -o athena/DO_TD/europe -a DO_TD -p athena_ht
...
if [ $progress -eq 2 ]; then
    ...
    python3 bench.py -args "-g graphs/asia_osm.mtx.sg -n 32"          -t 1 2 4 8 16 32 64 128 256 512 -d no -o athena/DO_TD/asia -a DO_TD -p athena_ht
...
if [ $progress -eq 3 ]; then
    ...
    python3 bench.py -args "-g graphs/hugebubbles-00020.mtx.sg -n 32" -t 1 2 4 8 16 32 64 128 256 512 -d no -o athena/DO_TD/hugebubbles -a DO_TD -p athena_ht
...
if [ $progress -eq 10 ]; then
    ...
    python3 bench.py -args "-g graphs/road_usa.mtx.sg -n 32"          -t 1 32 64 128 256 512 -d both -o athena/FAA/usa -a FAA -p athena_ht
...
if [ $progress -eq 11 ]; then
    ...
    python3 bench.py -args "-g graphs/europe_osm.mtx.sg -n 32"           -t 1 32 64 128 256 512 -d both -o athena/FAA/europe -a FAA -p athena_ht
...
if [ $progress -eq 12 ]; then
    ...
    python3 bench.py -args "-g graphs/asia_osm.mtx.sg -n 32"          -t 1 32 64 128 256 512 -d both -o athena/FAA/asia -a FAA -p athena_ht
...
if [ $progress -eq 13 ]; then
    ...
    python3 bench.py -args "-g graphs/hugebubbles-00020.mtx.sg -n 32" -t 1 32 64 128 256 512 -d both -o athena/FAA/hugebubbles -a FAA -p athena_ht
