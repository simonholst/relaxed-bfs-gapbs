...
protected:
    ...
    static thread_local XoshiroCpp::Xoroshiro128PlusPlus _generator;
    static thread_local uniform_int_distribution<int> _distribution;
};

template <typename QueueType, typename ElementType, int SampleSize, int SubQueueCount>
thread_local XoshiroCpp::Xoroshiro128PlusPlus DCBOQueueBase<QueueType, ElementType, SampleSize, SubQueueCount>::_generator{random_device{}()};
